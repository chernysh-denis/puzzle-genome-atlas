...
4. the supporting game's exact and near matches have been calculated with the
   canonical formula;
5. evidence status and confidence are explicit.

TODO: keep leads in this index until repeated entries make its columns
insufficient. A separate lead template is deliberately deferred because no
individual lead has yet earned a full research record.
